...
def add_InferenceServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'InferVideo': grpc.unary_unary_rpc_method_handler(
                    servicer.InferVideo,
                    request_deserializer=inference__pb2.InferVideoRequest.FromString,
                    response_serializer=inference__pb2.JobResponse.SerializeToString,
            ),
            'GetResult': grpc.unary_unary_rpc_method_handler(
                    servicer.GetResult,
                    request_deserializer=inference__pb2.GetResultRequest.FromString,
